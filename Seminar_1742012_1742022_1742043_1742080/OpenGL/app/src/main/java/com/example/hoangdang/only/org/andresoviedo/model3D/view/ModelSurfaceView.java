...
import com.example.hoangdang.only.org.andresoviedo.model3D.controller.TouchController;
...
public class ModelSurfaceView extends GLSurfaceView {
    ...
    public ModelSurfaceView(Context context, AttributeSet attrs, ModelActivity parent) {
        super(context, attrs);
